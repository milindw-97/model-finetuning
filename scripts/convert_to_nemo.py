...
def main():
    ...
    info = {
        ...
        "splits": {
            "train": {"manifest": manifests.get("train"), "samples": len(train_ds)},
            "val": {"manifest": manifests.get("val"), "samples": len(val_ds)},
            "test": {"manifest": manifests.get("test"), "samples": len(test_ds)}
        }
    }
